...
import com.lrnplex.framework.Pool;
...
public class MultiTouchHandler implements TouchHandler{
    ...
    public boolean onTouch(View v, MotionEvent event){
        synchronized (this){
            ...
            int pointerIndex = (event.getAction() & MotionEvent.ACTION_POINTER_INDEX_MASK) >> MotionEvent.ACTION_POINTER_INDEX_SHIFT; //Make sure INDEX is replacement for deprecated ID
